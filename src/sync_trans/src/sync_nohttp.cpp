...
void talker::registerPubSub(){
  ...
  pose_sub = new message_filters::Subscriber<geometry_msgs::PoseStamped>(nh, "/vrpn_client_node/lianxu/pose", 10);
...
string obj_dir = "/home/perple/nerf_demo/src/sync_trans/obj_data/";
string calib_dir = "/home/perple/nerf_demo/src/sync_trans/calib_data/";
string test_dir;
